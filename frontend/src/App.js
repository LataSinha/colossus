  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          exact
          path="/karaokeRegistration"
          element={<KaraokeRegistration />}
        />
        <Route
          exact
          path="/quizzieBuzzieRegistration"
          element={<QuizzieBuzzie />}
        />
        <Route
          exact
          path="/codeManiaRegistration"
          element={<CodeManiaRegistration />}
        />
        <Route
          exact
          path="/biddersDateRegistration"
          element={<BiddersDateRegistration />}
        />
        <Route
          exact
          path="/papyrusRegistration"
          element={<PapyrusRegistration />}
        />
        <Route
          exact
          path="/webforcesRegistration"
          element={<WebForcesRegistration />}
        />
        ...
        <Route
          exact
          path="/concentricaRegistration"
          element={<ConcentricaRegistration />}
        />
        <Route
          exact
          path="/artOfYoursRegistration"
          element={<ArtOfYoursRegistration />}
        />
        <Route exact path="/pixofyRegistration" element={<PixofyReg />} />
        <Route exact path="/umangRegistration" element={<UmangReg />} />
        <Route
          exact
          path="/rockTillTheDropRegistration"
          element={<RockTillTheDropReg />}
        />
        <Route
          exact
          path="/beatExplosionRegistration"
          element={<BeatExplosionReg />}
        />
        <Route
          exact
          path="/nostalgicRacingRegister"
          element={<NostalgicRacingReg />}
        />
        <Route exact path="/codmRegister" element={<RampageReg />} />
        <Route
          exact
          path="/surSangamRegistration"
          element={<SurSangamRegistration />}
        />
