        ...
        <div>
            ...
            <VerticalTimeline>
                ...
                >
                 ...
                 <p style={{display:'flex'}}>5.&nbsp;&nbsp;&nbsp;&nbsp; <button  className="vertical-timeline-element-title" style={{background:'#000',color:'#fff',height:'30%',width:'80%',padding:'5%',borderRadius:'5px',fontFamily:'Gotham',fontSize:'150%'}}>Karaoke Marathon</button></p>
                 <p className="vertical-timeline-element-subtitle" style={{marginLeft:'5%'}}><i>Time:&nbsp;10:00 a.m to 1:00 p.m</i></p>
                 <p style={{display:'flex'}}>6.&nbsp;&nbsp;&nbsp;&nbsp; <button className="vertical-timeline-element-title" style={{background:'#000',color:'#fff',height:'30%',width:'80%',padding:'5%',borderRadius:'5px',fontFamily:'Gotham',fontSize:'150%'}}>Beat Explosion</button></p>
                 ...
                 <p style={{display:'flex'}}>9.&nbsp;&nbsp;&nbsp;&nbsp; <button className="vertical-timeline-element-title" style={{background:'#000',color:'#fff',height:'30%',width:'80%',padding:'5%',borderRadius:'5px',fontFamily:'Gotham',fontSize:'150%'}}>Art of Yours</button></p>
                 <p className="vertical-timeline-element-subtitle" style={{marginLeft:'5%'}}><i>Time:&nbsp;11:00 a.m to 1:00 p.m</i></p>
                 <p style={{display:'flex'}}>10.&nbsp;&nbsp;&nbsp;&nbsp; <button className="vertical-timeline-element-title" style={{background:'#000',color:'#fff',height:'30%',width:'80%',padding:'5%',borderRadius:'5px',fontFamily:'Gotham',fontSize:'150%'}}>Concentrica</button></p>
                ...
                >
                 ...
                 <p className="vertical-timeline-element-subtitle" style={{marginLeft:'5%'}}><i>Time:&nbsp;11:00 a.m to 3:00 p.m</i></p>
                 <p style={{display:'flex'}}>4.&nbsp;&nbsp;&nbsp;&nbsp; <button  className="vertical-timeline-element-title" style={{background:'#000',color:'#fff',height:'30%',width:'80%',padding:'5%',borderRadius:'5px',fontFamily:'Gotham',fontSize:'150%'}}>Sursangam</button></p>
                 <p className="vertical-timeline-element-subtitle" style={{marginLeft:'5%'}}><i>Time:&nbsp;10:00 a.m to 12:30 p.m</i></p>
                 <p style={{display:'flex'}}>5.&nbsp;&nbsp;&nbsp;&nbsp; <button  className="vertical-timeline-element-title" style={{background:'#000',color:'#fff',height:'30%',width:'80%',padding:'5%',borderRadius:'5px',fontFamily:'Gotham',fontSize:'150%'}}>Rock Till You Drop</button></p>
