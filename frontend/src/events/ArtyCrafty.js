...
import artyCrafty from "../assets/ArtyCrafty.png";
          ...
          <Grid container>
            <Grid item xs={6}>
              ...
              <p style={{ color: "#fff", marginLeft: "8%" }}>
                We are organizing a coding competition in our college fest for
                all the coding geeks.
              </p>
              <p style={{ color: "#fff", marginLeft: "8%" }}>
                The competition consists of two rounds and each round is an
                eliminatory round. The fastest and most accurate participant
                will be the winner of the contest.
              </p>
              ...
              <ul style={{ color: "#fff", marginLeft: "8%" }}>
                <li>
                  Students can register as individuals (Entry Fee Rs. 50 ).
                </li>
                <li>
                ...
                <li>
                  All Participants should have their college IDs with them.
                </li>
